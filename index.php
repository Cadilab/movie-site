...
<div class="contain_front_text alert">
	...
	<div class="container">
		...
		<?php
			...
			if(!check_login())
			{
				echo '<h3>Dobrodosli na MyMovies, Gost.</h3>';
			}
			elseif(check_login())
			{
				echo '<h3>Dobrodosli na MyMovies, ',$_SESSION['username'],'.</h3>';
			}
		...
		<p>
			...
			Na nasoj stranici mozete pronaci filmove, serije, dokumentarce u hd formatu. Svi filmovi su takodje besplatni.
			Zauzvrat bi vas zamolili da nas podrzite tako sto cete lajkovati nasu stranicu na socijalnim mrezama, facebook, instagram, twitter.
			Isto tako, ukoliko imate adblock, iskljucite ga, finansiramo se iskljucivo od reklama da bi mogli platiti web prostor.
